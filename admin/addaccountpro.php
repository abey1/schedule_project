...
$sql = "INSERT INTO `head`(`fname`, `mname`, `lname`, `address`, `email`, `age`, `sex`, `uname`, `pass`) VALUES ('".$fname."','".$mname."','".$lname."','".$addres."','".$email."','".$age."','".$sex."','".$uname."','".$pass."')";
$run = $con->query($sql);
...
//header("Location:admin/index.php");
  ...
  echo '<script language="javascript">';
     echo 'alert("email allready exist please use an other email")';
      echo '</script>';
        echo '<meta http-equiv="refresh" content="0;url=addacount.php" />';
}
?>