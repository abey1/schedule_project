        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="account.php" class="nav-item nav-link"><i class="fa fa-users me-2"></i>Manage Account</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Department Heads</p>
                                <?php
                                // include('../connection.php');
                                //  $result=$con->query("SELECT count(*) as total from head");
                                //  $data=$result->fetch_assoc();
                                //  $percent = $data['total'];
                                // echo "<h6 class='mb-0'>"; echo $percent;   echo"</h6>";
                                ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <?php
                                // include('../connection.php');
                                //  $result=$con->query("SELECT count(*) as total from instructor");
                                //  $data=$result->fetch_assoc();
                                //  $percent = $data['total'];
                                // echo "<h6 class='mb-0'>"; echo $percent;   echo"</h6>";
                                ?>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Class Room</p>
                                <?php
                                // include('../connection.php');
                                //  $result=$con->query("SELECT count(*) as total from `class room`");
                                //  $data=$result->fetch_assoc();
                                //  $percent = $data['total'];
                                // echo "<h6 class='mb-0'>"; echo $percent;   echo"</h6>";
                                ?>
